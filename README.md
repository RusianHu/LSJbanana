...
| `openai_images` | OpenAI `/v1/images/generations` 与 `/v1/images/edits` 配置；GPT Image 2 会把宽高比和 1K / 2K / 4K 档位转换为官方 `WIDTHxHEIGHT`；`verify_output_size` 可检查上游是否忽略尺寸，`force_ipv4` 可规避部分 IPv6 长连接断流 |
