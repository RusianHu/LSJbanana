...
return [
    ...
    'api' => [
        ...
        'deduct_failed' => '扣费失败',
        'generation_enqueue_failed' => '图片任务入队失败，请稍后重试',
        ...
        'image_queue_busy' => '唯一图片渠道正在处理其他任务，请稍后再试。本次请求未扣费。',
        'image_queue_unavailable' => '图片渠道并发保护暂时不可用，请联系管理员。本次请求未扣费。',
        'upstream_error_refunded' => ':message；本次预扣费用已退还。',
        'upstream_error_refund_failed' => ':message；自动退款失败，请联系管理员并提供错误追踪 ID。',
