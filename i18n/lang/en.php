...
return [
    ...
    'api' => [
        ...
        'generation_enqueue_failed' => 'Failed to queue the image task. Please try again later.',
        ...
        'image_queue_busy' => 'The only image channel is processing another task. Please try again later. This request was not charged.',
        'image_queue_unavailable' => 'Image channel concurrency protection is temporarily unavailable. Contact the administrator. This request was not charged.',
        'upstream_error_refunded' => ':message; the pre-deducted charge has been refunded.',
        'upstream_error_refund_failed' => ':message; the automatic refund failed. Contact the administrator with the error trace ID.',
